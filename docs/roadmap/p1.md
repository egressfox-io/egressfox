...
Status: active implementation plan. M7–M8 and M8.5 C1 are complete; C2–C4
remain before M9.
...
**Status: C1 foundation complete; C2–C4 pending.** M8, including its bounded subscription
...
preserves existing identities. No C2–C4 support is implied by the C1 types.
