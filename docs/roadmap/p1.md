...
Status: active implementation plan. M7–M8 and M8.5 C1–C2 are complete; C3–C4
remain before M9.
...
**Status: C1–C3 complete; C4 implemented with native/managed qualification pending.** M8, including its bounded subscription
...
The [C1 exact-profile matrix](../designs/engine-protocol-compatibility.md) now
records those boundaries and the [v3 identity decision](../decisions/0021-version-three-connection-semantics-and-capabilities.md)
preserves existing identities. The qualified C2 subset is recorded in the
[subscription](../designs/subscription-compatibility.md) and
[engine](../designs/engine-protocol-compatibility.md) matrices. C3/C4 behavior
is not implied by the C1 types.
