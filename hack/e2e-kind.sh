...
spec:
  ...
  ports: [{name: hy2, protocol: UDP, port: 8461, targetPort: 8461}]
YAML
...
hy2://synthetic-hy2-auth@${c4_hy2_ip}:8461?sni=proxy-server&insecure=1&obfs=salamander&obfs-password=synthetic-hy2-obfs&upmbps=20&downmbps=40
EOF
